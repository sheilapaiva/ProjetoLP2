...
class TestePl {
	...
	@BeforeEach
	public void setUp() {
		Pl1 = new Pl("Pl 1/2016", "061444444-0",2016,"Regulamenta a tributacao de apostas eletronicas", "fiscal,jogos", "https://example.net/jogos%40aposta", true );
		Pl2 = new Pl("Pl 1/2016", "061444444-0",2016,"Regulamenta a tributacao de apostas eletronicas", "fiscal,jogos", "https://example.net/jogos%40aposta", true );
		Pl3 = new Pl("Pl 1/2017", "061444444-9",2017,"Institui a semana do carinho nas escolas", "cidadania,educacao basica", "https://example.net/jogos%40aposta", true );
	}
