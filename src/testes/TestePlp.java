...
class TestePlp {
	...
	@BeforeEach
	public void setUp() {
		plp1 = new Plp("PLP 1/2016", "061444444-0",2016,"Regulamenta a tributacao de apostas eletronicas", "fiscal,jogos", "https://example.net/jogos%40aposta", "153");
		plp2 = new Plp("PLP 1/2016", "061444444-0",2016,"Regulamenta a tributacao de apostas eletronicas", "fiscal,jogos", "https://example.net/jogos%40aposta", "153");
		plp3 = new Plp("PLP 1/2017", "061444444-9",2017,"Institui a semana do carinho nas escolas", "cidadania,educacao basica", "https://example.net/jogos%40aposta", "153");
	}
